...
class MainActivity : AppCompatActivity() ,NavigationView.OnNavigationItemSelectedListener{
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            ...
            R.id.nav_services -> supportFragmentManager.beginTransaction().replace(R.id.fragment_container,OldserviceFragment()).commit()

            R.id.nav_cash -> supportFragmentManager.beginTransaction().replace(R.id.fragment_container,CashFragment()).commit()

            R.id.nav_language -> supportFragmentManager.beginTransaction().replace(R.id.fragment_container,LanguageFragment()).commit()

            R.id.nav_account -> supportFragmentManager.beginTransaction().replace(R.id.fragment_container,AccountFragment()).commit()
